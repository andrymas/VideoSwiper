...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1996549864;
...
fn wire__crate__api__collage_generation__generate_collage_impl(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::collage_generation::generate_collage(
                            api_sink,
                            api_paths,
                            api_num_frames,
                            api_quality,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__collage_generation__generate_collage_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
